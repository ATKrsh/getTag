        ...
        <div>
          <div className="flex items-center gap-2">
            <h1 className="text-sm font-bold tracking-wider text-white font-mono">
              get<span className="text-accent-neon">Tag</span>
            </h1>
          ...
          <p className="text-[10px] font-mono text-slate-400">
            Media Keyword & Tag Extraction Engine
          </p>
        </div>
      </div>
        ...
        {isProcessing ? (
          ...
          <div className="hidden sm:flex items-center gap-3 text-slate-400 text-[11px]">
            ...
            <span className="flex items-center gap-1">
              ...
              <strong className="text-accent-neon">{uniqueTagsCount}</strong> unique tags extracted
            </span>
          </div>
        )}
      </div>
